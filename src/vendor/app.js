...
$(function() {
  ...
  // Animate scroll on click on an anchor link
  ...
  $('.page-title .heading-elements-toggle, .panel-title .heading-elements-toggle').on(
    'click',
    function() {
      $(this)
        .parent()
  ...
  $('.breadcrumb-line')
    ...
    .prepend('<a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>');
  ...
  $('.category-title [data-action=collapse]').click(function(e) {
    ...
    $(this)
      ...
      .toggleClass('category-collapsed');
  ...
  $('.sidebar-mobile-main-toggle').on('click', function(e) {
    ...
    $('body')
      ...
      .removeClass('sidebar-mobile-secondary sidebar-mobile-opposite');
  });
  ...
  $('.sidebar-mobile-secondary-toggle').on('click', function(e) {
    ...
    $('body')
      ...
      .removeClass('sidebar-mobile-main sidebar-mobile-opposite');
  });
